...
class DoctorInline(admin.StackedInline):
    ...
    fk_name = 'user'
    fields = ['medical_code', 'specialty', 'monthly_reservation_capacity', 'avatar', 'wallet']
    readonly_fields = ['medical_code', 'wallet']
    

class CustomUserAdmin(UserAdmin):
    inlines = [PatientInline, DoctorInline]
    list_display = ['username', 'email', 'first_name', 'last_name', 'phone', 'role', 'is_staff', 'is_active', 'get_user_type']
